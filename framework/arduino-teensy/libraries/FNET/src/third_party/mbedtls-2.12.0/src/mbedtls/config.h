 ...
 */
// Disabled because mbedtls_sha384_init(), mbedtls_sha384_clone(), mbedtls_sha384_finish_ret()
// appear to be using 64 bytes but take buffers of only 48 bytes
// Does disabling SHA512 cause any actual compatibility problems?
